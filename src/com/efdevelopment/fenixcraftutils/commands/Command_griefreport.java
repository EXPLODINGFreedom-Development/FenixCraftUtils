...
public class Command_griefreport extends BukkitCommand<FenixCraftUtils> {

    @Override
    public boolean run(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        Bukkit.broadcastMessage(ChatColor.RED + "ADMINS: " + sender.getName() + " found grief. Please come and inspect.");
